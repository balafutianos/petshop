...
const Navbar = () => {
  ...
  const greekMenuItems = [
    ...
    },
    {
      ...
      isHome: false,
      submenu: [
        { label: "Τροφές", href: "/birds/food", active: true },
    ...
    const loadProducts = async () => {
      try {
        const qNoOrder = query(
          collection(db, "birdproduct"),   // <-- έλεγξε το όνομα συλλογής σου
        ...
        >
          <div>
            ...
            <p style={{ opacity: 0.95, marginTop: 6 }}>
              Ποικιλία τροφών για τους φτερωτούς μας φίλους — ενημερώνονται από Firebase.
            </p>
          </div>
        </section>
