...
import "./CatFood.css";            // ίδιο CSS (θα προσθέσεις λίγες γραμμές πιο κάτω)
...
const Navbar = () => {
  ...
  const greekMenuItems = [
    { label: "Αρχική", isHome: true, submenu: [] },
    {
      ...
      isHome: false,
      submenu: [
        { label: "Τροφές", href: "/dogs/food", active: true },
...
const DogFood = () => {
  ...
  return (
    <>
      ...
      <main
        id="dog-food" /* <-- για να “πιάνει” και ξεχωριστό CSS αν θες */
      ...
      >
        ...
        >
          <div>
            <h1>Τροφές Σκύλου</h1>
            <p style={{ opacity: 0.95, marginTop: 6 }}>Ξηρά & υγρά για τους καλύτερους μας φίλους.</p>
          </div>
        </section>
          ...
          <ul className="product-grid">
            {dogproducts.map((p) => (
              <li key={p.id} className="product-card">
                <a className="card-link" href={`#/product/${p.id}`} onClick={(e) => e.preventDefault()}>
